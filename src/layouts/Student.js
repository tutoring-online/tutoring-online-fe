...
const PrivateRoute = (props) => {
    ...
    return <Route {...props} />
    // if (isSignedIn && isStudent(user?.role)) {
    //     return <Route {...props} />
    // }
...
const getStudentRoutes = () => {
    const studentRoutes = routes.filter(route => route.layout === LAYOUT_PATHS.student);
    return isAvailableArray(studentRoutes) ? [...studentRoutes] : [];
}
