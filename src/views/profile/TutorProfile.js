...
export default function TutorProfile() {
  ...
  // const actions = useTutorSubjectActions();
  // useEffect(() => {
  //   actions.getTutorSubject({ id: 10 });
  // }, []);
  ...
  useEffect(() => {
    actions.fetchTutorDetail({ id : user?.id });
  }, [])
                  ...
                  >
                    <Tooltip title="Gender" placement="right">
                      <Box
                        ...
                        paddingBottom="7px"
                      >
                        {convertNumberToGender(user?.gender) || (
                          <NoInformation />
                        )}
                      </Box>
                    </Tooltip>
      ...
      <Grid container>
        <Grid item xs={12} lg={12}>
          <Grid container>
            ...
            <Grid item xs={12} lg={8} marginLeft="-3.5rem">
              <Box style={{ width: "100%", height: "40px" }}>
        ...
        <Grid item xs={12} lg={12}>
          <Grid container>
            <Grid item xs={12} lg={1.5} paddingLeft="2rem" paddingTop="6px">
              <Box width={20} height={20} paddingTop="6px">
                <GroupsRoundedIcon style={{ width: "100%", height: "100%" }} />
              </Box>
            </Grid>
            <Grid item xs={12} lg={8} marginLeft="-3.5rem">
              <Box style={{ width: "100%", height: "40px" }}>
                <Box display="flex" height="100%" paddingTop="17px">
                  <Box
                    display="flex"
                    alignItems="center"
                    backgroundColor="#fff"
        ...
        <Grid item xs={12} lg={12} marginTop="1rem" paddingBottom="1rem">
          <Grid container>
            <Grid item xs={12} lg={1.5} paddingLeft="2rem" paddingTop="6px">
              <Box width={20} height={20}>
                  ...
                  >
                    <Tooltip title="Description" placement="top">
                      <Box
                        ...
                        maxWidth="600px"
                      >
                        {tutor?.description || <NoInformation />}
                      </Box>
                    </Tooltip>
                  </Box>
                </Box>
